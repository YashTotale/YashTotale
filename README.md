...
**Current Weather**: <!-- START WEATHER --><img src="assets/pleasanton/weather.png" alt="" height="10" /> Patchy frost after 4am. Partly cloudy. Low around 33, with temperatures rising to around 35 overnight. East wind around 2 mph.<!-- END WEATHER -->
...
<p align="center">This <code>README</code> file is generated <strong>every 3 hours</strong>!<br>Last refresh: <!-- START REFRESH -->Friday, December 10, 10:04 PM PST<!-- END REFRESH --></p>
