...
**Current Weather**: <!-- START WEATHER --><img src="assets/pleasanton/weather.png" alt="" height="10" /> Partly cloudy. Low around 46, with temperatures rising to around 48 overnight. East northeast wind around 2 mph.<!-- END WEATHER -->
...
<p align="center">This <code>README</code> file is generated <strong>every 3 hours</strong>!<br>Last refresh: <!-- START REFRESH -->Tuesday, November 16, 10:05 PM PST<!-- END REFRESH --></p>
