...
**Current Weather**: <!-- START WEATHER --><img src="assets/pleasanton/weather.png" alt="" height="10" /> Patchy fog and a slight chance of rain showers. Mostly cloudy. Low around 48, with temperatures rising to around 50 overnight. East wind around 1 mph. Chance of precipitation is 20%.<!-- END WEATHER -->
...
<p align="center">This <code>README</code> file is generated <strong>every 3 hours</strong>!<br>Last refresh: <!-- START REFRESH -->Friday, November 19, 4:08 AM PST<!-- END REFRESH --></p>
