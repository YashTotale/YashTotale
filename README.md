...
**Current Weather**: <!-- START WEATHER --><img src="assets/pleasanton/weather.png" alt="" height="10" /> Isolated rain showers before 3am, then patchy fog and isolated rain showers. Mostly cloudy. Low around 56, with temperatures rising to around 58 overnight. East northeast wind around 1 mph. Chance of precipitation is 20%. New rainfall amounts less than a tenth of an inch possible.<!-- END WEATHER -->
...
<p align="center">This <code>README</code> file is generated <strong>every 3 hours</strong>!<br>Last refresh: <!-- START REFRESH -->Tuesday, November 2, 2:03 AM PDT<!-- END REFRESH --></p>
