...
**Current Weather**: <!-- START WEATHER --><img src="assets/pleasanton/weather.png" alt="" height="10" /> A chance of rain. Cloudy. Low around 45, with temperatures rising to around 47 overnight. West southwest wind around 9 mph, with gusts as high as 21 mph. Chance of precipitation is 40%.<!-- END WEATHER -->
...
<p align="center">This <code>README</code> file is generated <strong>every 3 hours</strong>!<br>Last refresh: <!-- START REFRESH -->Thursday, December 9, 1:04 AM PST<!-- END REFRESH --></p>
